...
function pagebuttons(pages){
    ...
    for (let page = 0; page < pages; page++) {
        ...
        button.value=page+1;
        button.setAttribute('onclick','(state.page=this.value),data = pagination(state.quereyset,state.page,state.rows);inputTable= buildTable(data);')
...
function buildTable (variable1){
    
row1col2.innerHTML='';


let mylist= variable1.quereyset;
let table= document.createElement('table');
table.classList.add('table', 'table-striped', 'table-dark', 'rounded');
table.innerHTML='';
...
let td1= document.createElement('td');
td1.classList.add();
td1.innerText=mylist[index].id;
let td2= document.createElement('td');
td2.classList.add();
td2.innerText=mylist[index].name;
let td3= document.createElement('td');
td3.classList.add();
td3.innerText=mylist[index].email;
tr.append(td1,td2,td3);
table.append(tr);
if(flag===true & row1col2.innerHTML==='' ){
   
    row1col2.append(table);
     let pagebtn= pagebuttons(data.pages);
  row1col2.append(pagebtn);
}
}
return table;
}
...
row1col2.classList.add('col');
 ...
 var inputTable= buildTable(data);
  row1col2.append(inputTable);
